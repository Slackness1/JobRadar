...
# 5 canonical reject reasons agreed in §2 D-2. The UI shows the Chinese label
# on the inline form; backend stores both the machine key (for analytics) and
# the label (for memory.summary so the 我的档案 panel reads naturally).
