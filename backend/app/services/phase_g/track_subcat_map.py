...
CANONICAL_TRACK_TO_SUBCATS: dict[str, list[str]] = {
    ...
    "量化": [
        ...
        "量化开发QD",
        "AI 量化工程师",
        "海外买方量化/衍生品研究",   # v1: 收编孤儿桶(原伞词召不到)
        # "买方 Quant" v1 删:库内 0 岗的死映射,已被上面的细分桶取代
    ],
    "卖方研究": [
        "卖方研究员·TMT",
        "卖方研究员·消费医药周期",
        "卖方研究员·宏观策略",
        "卖方研究员·金融/地产",   # v1 老师新增(待打标的岗归位后即可召回)
        "卖方固收研究员",          # v1 老师新增
    ],
    "S&T·FICC·衍生品": [
        "固收交易员",
        "权益/自营交易员",        # v1 2026-06-19 老师拍板新增: 权益/自营/做市 交易台, 此前无归宿桶被误塞研究/中后台
        "利率宏观策略",
        "结构化产品衍生品",
        "机构销售·销售支持",
        "债券承做DCM·ABS/REITs",
    ...
    "一级股权·PE/VC": [
        "PE投后VC行研",
        "PEVC投资研究·投后支持",   # v1: 收编孤儿桶(与上者同义,等 DB 合并后归一)
    ],
    "银行·总行核心": [
        "信用研究员",
        "基金产品运营·中后台",
