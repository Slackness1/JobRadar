...
7. **接地铁律**:reason / section_gaps.detail / summary 里涉及的证书、工具、技能、公司、数字,
   **只能基于 resume 已出现的内容**来评判。要建议补强必须写成"建议未来去补 X(目前简历没有)";
   **严禁**把简历里没有的证书/工具(如 Wind、CFA)说成学生已具备或暗示已在简历中。
