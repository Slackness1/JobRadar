...
ALIAS_MAP: dict[str, list[str]] = {
    ...
    "工商银行": ["工行", "ICBC"],
    "建设银行": ["建行", "CCB"],
    "易方达基金": ["易方达"],  # 3 字 distinctive
    "嘉实基金": ["嘉实基金管理"],
    "汇添富基金": ["汇添富"],  # 3 字
    "工银瑞信基金": ["工银瑞信"],  # 4 字
    "兴证全球基金": ["兴证全球", "兴全基金"],
    # 注意: 华夏/南方/广发/招商 是 2 字通用前缀, 会跨产品线误命中 (广发基金 vs 广发证券)
    # 走完整名 + alias_map 内显式 4 字 alias, 不给 2 字兜底
    "申万宏源": ["申万宏源证券"],
    "国泰海通": ["国泰君安", "海通证券"],
    "九坤投资": ["九坤"],
    "明汯投资": ["明汯"],
    ...
    "国寿投资": ["国寿", "中国人寿"],
    "中再资产": ["中再"],
    # AI 应用初创 是 ground_truth 里的 wildcard 类别 - 匹配头部 AI 创业公司池
    "AI 应用初创 (头部创业)": [
        "DeepSeek", "深度求索", "月之暗面", "Kimi", "Moonshot",
        "智谱AI", "智谱清言", "Zhipu",
        "MiniMax", "稀宇科技",
        "阶跃星辰", "Step",
        "百川智能", "Baichuan",
